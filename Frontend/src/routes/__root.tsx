  ...
  head: () => ({
    meta: [
      ...
      { title: "Signal — AI Resume & Job Matching" },
      {
        name: "description",
        content:
          "Upload your resume and get ranked, explainable job recommendations with concrete suggestions to strengthen each application.",
      },
      { property: "og:title", content: "Signal — AI Resume & Job Matching" },
      {
        property: "og:description",
        content: "Deterministic skill matching, transparent scoring, and supportive guidance.",
      },
